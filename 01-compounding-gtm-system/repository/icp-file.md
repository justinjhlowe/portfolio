...
- Revenue: $20M–$250M
- Industry: SaaS, healthcare services, logistics, in that priority order as of v2 (see change history for why logistics moved up)
...
- No budget or funding signal in current fiscal quarter, even at high firmographic fit, added v2 (see change history: this alone explained two of three losses)

### Tiering

- **Tier 1 (score 80 to 100):** immediate outbound, signal-to-sequence eligible
- **Tier 2 (score 50 to 79):** nurture, revisit if a new signal fires
